...
class FavoriteManager: ObservableObject {
    ...
    private func subscribeToFavoriteAlerts(_ favorite: FavoritePlace) {
        BackendClient.shared.subscribeToAlerts(
            ...
            if success {
                print("Subscribed to alerts for favorite: \(favorite.name)")
            } else {
                print("Failed to subscribe to alerts for \(favorite.name): \(message)")
            }
        }
    }
    ...
    private func loadFavoriteAlerts() {
        ...
        do {
            ...
            print("Failed to load favorite alerts: \(error)")
        }
    }
    ...
    private func saveFavoriteAlerts() {
        do {
            ...
            print("Failed to save favorite alerts: \(error)")
        }
    }
