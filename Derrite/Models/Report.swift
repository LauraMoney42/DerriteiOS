...
struct Report: Identifiable, Codable {
    ...
    init(id: String? = nil,
        ...
        // Use SecurityManager for anonymous ID generation
        self.id = id ?? SecurityManager.shared.generateAnonymousReportId()
        
        // Fuzzy location for privacy
        self.location = SecurityManager.shared.fuzzyLocation(location)
